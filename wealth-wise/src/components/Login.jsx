...
<p  className='text-xl text-gray-800 py-5 font-bold text-center'>Gain financial literacy and start your business!</p>
    <div className='w-full max-w-md bg-white p-8 rounded-lg shadow-md'>
      <h2 className='font-medium text-blue-500 text-xl text-center'>Login now</h2>
...
<div className='w-full max-w-md p-8 text-center'>
  <p>Do not have an account?  <Link to="/Signup"  className='text-blue-800 hover:text-green-300 hover:text-2xl'>Create account</Link></p>
</div>
